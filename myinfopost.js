...
var disqus_shortname="myinfodotwebdotid";
...
resizeThumbnail('thumb-post', 620, 350);

function resizeThumbnail2(parentID, size, size2) {
    var parent = document.getElementById(parentID),
        image = parent.getElementsByTagName('img');
    for (var i = 0; i < image.length; i++) {
...
resizeThumbnail2('PopularPosts1', 280, 140);
